        ...
        <div>
            ...
            <el-col :span="24" class="header">
                <el-col :span="24" class="order-nav">
                    <el-col align="center" :span="1">选择</el-col>
                    <el-col :span="15" :offset="1">栏目名称</el-col>
                    <el-col :span="4">排序号</el-col>
                    <el-col align="center" :span="3">操作</el-col>
                </el-col>
                <el-col :span="24">
                    <el-tree
                        :data="catList"
...
<script>
	import { getGoodsCatList, addGoodsCat, delGoodsCat, editGoodsCat } from 'api';
	export default {
        data () {
            return {
                addCatDialog: false,
        ...
        mounted() {
            ...
            // console.log(delGoodsCat);
        },
        methods: {
            // 获取分类列表
            getGoodsCatList() {
                getGoodsCatList().then(res => {
