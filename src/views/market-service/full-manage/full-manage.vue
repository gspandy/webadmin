        ...
        <el-col :span="24"
            ...
            <el-form :inline="true"
                ...
                <el-form-item label="创建时间:">
                    <el-date-picker v-model="filterForm.creatAt"
                                    type="datetime"
                                    placeholder="选择日期时间">
                    </el-date-picker>
                ...
                <el-form-item label="至">
                    <el-date-picker v-model="filterForm.creatEnd"
                                    type="datetime"
                                    placeholder="选择日期时间">
                    </el-date-picker>
                </el-form-item>
...
<style>
    ...
    .full-section .tabel-pagination {
            margin: 50px 0;
    }
    .full-section .center {
        text-align: center!important;
    }
    .full-section .customer-tabel .cell {
        text-align: center;
    }
</style>