        ...
        <el-form :model="ruleForm"
            ...
            <el-row class="no-margin">
                ...
                <el-col :span="24"
                    ...
                    <el-col :span="10">
                        <el-col :span="16">
                            <el-form-item label="团购价格:" label-width="80px">
                        ...
                        <el-col :span="7"
                            ...
                            <el-input placeholder="原价">
                            </el-input>
                        </el-col>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="活动库存:" label-width="80px">
                            <el-input placeholder="0">
                            </el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="5">
                        <el-form-item label="成团人数:" label-width="80px">
                            <el-input placeholder="0">
                            </el-input>
                        </el-form-item>
                    </el-col>
...
<style>
    ...
    .release-section .no-margin .el-form-item,
    .release-section .no-margin .el-form-item {
        margin-bottom: 0;
    }

    .release-section .flex {
        display: flex;
        align-items: center
    }

    .release-section .line {
        text-align: center
    }

    .release-section i.el-icon-plus {
        color: #8492a6;
        cursor: pointer;
        opacity: 0.7;
        transition: all .5s
    ...
    .release-section .el-col-2 {
        color: #48576a
    }

    .release-section i.el-icon-plus:hover {
        opacity: 1
    }

    .release-section i.sub {
        width: 20px;
        height: 20px;
    ...
    .release-section .product-list {
        border-bottom: 1px dashed #f5f5f5;
        padding-bottom: 10px;
    }

    .release-section .product-list .label {
        width: 80px;
        text-align: right;
        padding-right: 12px;
    }

    .release-section .product-list .group-price label {
        width: 100px;
    }

    .release-section .product-info {
        display: flex;
        padding: 10px 0;
    }

    .release-section .product-info img {
        width: 80px;
        height: 80px;
        margin-right: 10px;
    }

    .release-section .product-info .product-info-title p {
        margin: 0 0 10px;
    }

    .release-section .product-info .product-info-title em {
        color: red;
    }
